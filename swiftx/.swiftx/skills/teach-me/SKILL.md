...
| `--resume`        | Resume previous session from `.swiftx/skills/teach-me/records/{topic-slug}/` |
...
All teach-me data is stored under `.swiftx/skills/teach-me/records/`:

```
.swiftx/skills/teach-me/records/
...
3. Load learner profile if `.swiftx/skills/teach-me/records/learner-profile.md` exists.
...
5. Create output directory: `.swiftx/skills/teach-me/records/{topic-slug}/`
...
3. Update `.swiftx/skills/teach-me/records/learner-profile.md` (keep under 30 lines):
